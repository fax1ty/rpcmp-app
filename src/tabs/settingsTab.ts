    ...
    .onAppear.once(({ target: tab }) => {
        ...
        tab
            .append(
                ...
                new ScrollView({ left: 0, right: 0, top: 'prev() 25', bottom: 0, scrollbarVisible: false })
                    .append(
                        new Composite({ padding: 25, left: 25, right: 25, cornerRadius: 18, background: currentStyle.colors.contrast })
                            .append(
                                new Composite()
                                    .append(
